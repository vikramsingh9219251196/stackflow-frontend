...
const Widget = ({theme}) => {
  return (
    <div className="widget">
      <h4 className={`h4 ${theme}`}>The Overflow Blog</h4>
      <div className={`right-sidebar-div-1${theme}`}>
        ...
        <div className={`right-sidebar-div-2${theme}`}>
          <img src={pen} alt="pen" width="18" />
          <p>Podcast 374: How valuable is your screen name?</p>
        </div>
      </div>
      <h4 className={`h4 ${theme}`}>Featured on Meta</h4>
      <div className={`right-sidebar-div-1${theme}`}>
        <div className={`right-sidebar-div-2${theme}`}>
      ...
      <h4 className={`h4 ${theme}`}>Hot Meta Posts</h4>
      <div className={`right-sidebar-div-1${theme}`}>
        <div className={`right-sidebar-div-2${theme}`}>
          <p>38</p>
          <p>
